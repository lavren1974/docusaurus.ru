...
- **[Autogenerated](autogenerated.md)**: автоматически генерирует фрагмент боковой панели
- **[HTML](#sidebar-item-html)**: отображает чистый HTML на месте элемента
- **[\*Ref](multiple-sidebars.md#sidebar-item-ref)**: ссылка на страницу документации, без добавления ее в навигацию
